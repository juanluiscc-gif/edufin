...
INSERT INTO "Lesson" (id, title, description, content, difficulty_level, age_group, display_order, estimated_minutes, "createdAt", "updatedAt") VALUES
('lesson-1', 'What is Money?', 'Learn about the concept of money and why we use it', '# What is Money?
...
Understanding money is the first step to being financially smart!', 1, 'both', 1, 10, NOW(), NOW()),

('lesson-2', 'Counting Money', 'Practice identifying and counting coins and bills', '# Counting Money
...
Practice counting money every day to get better!', 1, 'kid', 2, 15, NOW(), NOW()),

('lesson-3', 'Earning Money', 'Learn about different ways people earn money', '# Earning Money
...
Start thinking about what skills you want to develop!', 2, 'both', 3, 12, NOW(), NOW()),

('lesson-4', 'Needs vs Wants', 'Understanding the difference between needs and wants', '# Needs vs Wants
...
Understanding needs vs wants helps you spend money wisely!', 2, 'both', 4, 10, NOW(), NOW()),

('lesson-5', 'Saving Money', 'Why and how to save money for future goals', '# Saving Money
...
Start saving today, no matter how small!', 2, 'both', 5, 15, NOW(), NOW()),

('lesson-6', 'Creating a Budget', 'Learn how to create and stick to a monthly budget', '# Creating a Budget
...
Start your budget today!', 3, 'adult', 6, 20, NOW(), NOW()),

('lesson-7', 'Understanding Credit', 'Learn about credit scores, credit cards, and borrowing', '# Understanding Credit
...
Credit is a tool - use it wisely!', 4, 'adult', 7, 18, NOW(), NOW());

-- ============================================
-- INSERT GAMES
-- ============================================

INSERT INTO "Game" (id, title, description, game_type, age_group, difficulty_level, max_score, "createdAt", "updatedAt") VALUES
('game-1', 'Money Math Challenge', 'Test your skills at counting coins and making change', 'quiz', 'kid', 2, 100, NOW(), NOW()),
('game-2', 'Lemonade Stand', 'Run your own lemonade stand and learn about profit', 'simulation', 'kid', 2, 100, NOW(), NOW()),
('game-3', 'Coin Sorter', 'Sort coins and make exact change as fast as you can', 'puzzle', 'kid', 1, 100, NOW(), NOW()),
('game-4', 'Birthday Money Decision', 'You got birthday money! What will you do with it?', 'scenario', 'kid', 1, 100, NOW(), NOW()),
('game-5', 'Budget Master', 'Create and manage a monthly budget challenge', 'simulation', 'adult', 3, 100, NOW(), NOW()),
('game-6', 'Investment Matcher', 'Match investment types to their risk levels', 'puzzle', 'adult', 3, 100, NOW(), NOW()),
('game-7', 'Credit Score Quiz', 'Test your knowledge of credit scores and credit cards', 'quiz', 'adult', 3, 100, NOW(), NOW()),
('game-8', 'Emergency Fund Scenario', 'Navigate unexpected expenses and make smart financial decisions', 'scenario', 'adult', 4, 100, NOW(), NOW());
