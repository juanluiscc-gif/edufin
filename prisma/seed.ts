...
Credit is a tool - use it wisely!`,
  ...
  const games = [
    ...
    {
      title: '🏪 Simulación de Negocio Unificado',
      description: 'Gestiona múltiples conversaciones simultáneas con clientes, proveedores y socios. Sistema de progresión por niveles (2 minutos)',
      game_type: GameType.simulation,
      age_group: AgeGroup.both,
      difficulty_level: 3,
      max_score: 2000,
